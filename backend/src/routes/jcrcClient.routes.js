...
import { validarCreateDatosClient } from "../validations/jcrcClient.validation.js";
...
routerClient.put('/actualizarClient/:id', validarToken, validarCreateDatosClient, updateClient)
